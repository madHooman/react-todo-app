...
export default function NewProject({onAdd ,onCancelAdd}) {
    ...
    function handleSave(){
        ...
        if (enteredTitle.trim() ==='' || enteredDescription.trim() ===''    || enteredDeuDate.trim() === '') {
modal.current.open();
return;
        }
        onAdd({
    ...
    <p className="text-stone-600  mb-4">please make sure you provide a valid value for every input field</p>
        ...
        <div className="w-[35rem] mt-16">
            <menu className="flex items-center justify-end gap-4 my-4">
                <li>
                    <button className="text-stone-800 hover:text-stone-950" onClick={onCancelAdd}>cancel</button>
                </li>
                <li>
